...
if __name__ == "__main__":
    ...
    g=input("Enter turbine coordinates file name:")
    ...
    wind_inst_freq2 =  binWindResourceData(r'../Shell_Hackathon Dataset/Wind Data/wind_data_2008.csv') 
    wind_inst_freq3 =  binWindResourceData(r'../Shell_Hackathon Dataset/Wind Data/wind_data_2007.csv')    
    ...
    AEP1 = getAEP(turb_rad, turb_coords, power_curve, wind_inst_freq1,n_wind_instances, cos_dir, sin_dir, wind_sped_stacked, C_t)
    AEP2 = getAEP(turb_rad, turb_coords, power_curve, wind_inst_freq2,n_wind_instances, cos_dir, sin_dir, wind_sped_stacked, C_t)
    AEP3 = getAEP(turb_rad, turb_coords, power_curve, wind_inst_freq3,n_wind_instances, cos_dir, sin_dir, wind_sped_stacked, C_t)
