...
def greedy_F(k,offset,G_r_x,G_c_y,rs_start,rows,cs_start,columns,S,r_x,r_y,turb_rad,power_curve,XI_x,XI_y,dc):
    print('Greedy-F')
                ...
                if(feasible(rr,cc,XI_x,XI_y,G_r_x,G_c_y)):
                    ...
                    if F(Cp,rr,cc,XI_x,XI_y,G_r_x,G_c_y) >= offset+k-i-1 :
                        ...
                        for wind_inst_freq in dc:
                            A=getAEP(turb_rad, turb_coords, power_curve, dc[wind_inst_freq],n_wind_instances, cos_dir, sin_dir, wind_sped_stacked,C_t,ppp)
                            AEP=AEP+A**2
...
if __name__ == "__main__":
    ...
    XI_x,XI_y = greedy_F(50,0,G_r_x,G_c_y,40-40,79,40-40,79,S,r_x,r_y,turb_rad,power_curve,XI_x,XI_y,dc)
